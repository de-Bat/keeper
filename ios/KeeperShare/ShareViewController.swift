...
/// "Share → Keeper" from Photos, the screenshot editor, Safari, Instagram, etc.
///
...
private struct ShareView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                if count == 0 {
                    Text("No image found to save. Keeper saves screenshots and photos.")
                } else {
                    Section {
                        ...
                        Text("Keeper will identify what this is and look up the details when it syncs with your server.")
                    }
                }
            }
            .navigationTitle("Save to Keeper")
