    ...
    private var emptyState: some View {
        ContentUnavailableView {
            ...
            Text(store.items.isEmpty
                 ? "Share a screenshot to Magpie from Photos or right after taking it, tap + to pick one, or copy a link and tap the clipboard."
...
struct SyncBanner: View {
    ...
    var body: some View {
        switch sync.status {
        case .notConfigured:
            banner("Connect your Magpie server to identify screenshots. Everything you add is kept on this phone until then.",
